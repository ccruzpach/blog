        ...
        <x-panel class="max-w-sm mx-auto">
            <form method="POST" action="/admin/posts" enctype="multipart/form-data">
                ...
                <div class="mb-6">
                    ...
                    <input class="border border-gray-400 p-2 w-full" type="file" name="thumbnail" id="thumbnail" value="{{ old('slug') }}" required>
                ...
                <div class="mb-6">
                    ...
                    <textarea class="border border-gray-400 p-2 w-full" name="excerpt" id="excerpt" value="" required>{{ old('excerpt') }}</textarea>
